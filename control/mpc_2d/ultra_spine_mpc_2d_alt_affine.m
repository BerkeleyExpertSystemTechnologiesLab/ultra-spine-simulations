...
A_step = zeros(opt_params.num_states+1,opt_params.num_states+1,opt_params.num_pts);
B_step = zeros(opt_params.num_states+1,opt_params.num_inputs,opt_params.num_pts);
...
for i = 1:opt_params.num_pts+1
    ...
    [A_k, B_k] = linearize_dynamics_2d_affine(opt_params.xi,opt_params.u,opt_params.dt,dyn_type);
...
%     
        [outputs, opt_flag] = run_yalmip_opt_XZT_one_step(opt_params.horizon_length, ...
        xi, u, xi_ref, u_ref, opt_params.xi, A_k, B_k, 0, ...
        prev_u, opt_params.spine_params, opt_params.opt_time_lim);
    ...
    xi_kp1 = simulate_2d_spine_dynamics_kp1_affine(opt_params.xi,opt_params.u,opt_params.dt,1,dyn_type);
%    xi_cl(:,i+1) = xi_kp1;
