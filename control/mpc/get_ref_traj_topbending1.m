...
% This trajectory also includes bending in the T (theta) coordinate.
...
% For the T rotation: since it starts at zero radians, we need a new variable
%theta_T_rotation = linspace(0, (start_deg - max_deg), num_points);
