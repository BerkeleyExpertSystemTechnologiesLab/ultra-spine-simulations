...
% Adapted for the 2d system in feb 2018.

function [ full_traj, num_points_ref_traj ] = add_regulation_to_traj_2d( ref_traj, num_points_ref_traj_regulation )
% Inputs:
...
if( num_points_ref_traj_regulation == 0)
    ...
    % Recall that traj is (num system states) by (num timesteps), e.g., 6 by something large.
