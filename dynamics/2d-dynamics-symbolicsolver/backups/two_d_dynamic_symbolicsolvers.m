...
% ans = (500*(24*tensions_un3*cos(xi3 + pi/6) + 45*tensions_un1*sin(xi3) + 45*tensions_un2*sin(xi3) + ...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% While N = 3, error occurs at line 1117: 
% "In an assignment  A(:) = B, the number of elements in A and B must be
% the same";
% i = 1:length(d2xi_solved_un);
%     d2xi_solved_un(i) = replace_derivatives(getfield(d2xi_solved, char(d2xi(i))), xi, num_states_per_unit, debugging);
% 
% While N = 3:
