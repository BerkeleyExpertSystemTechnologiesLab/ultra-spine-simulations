function [ q, A, p, tensions] = InvKin_pseudoinv( C , x, y, z, forcesZ, momentsX, momentsY, momentsZ, coms, fixed, minCableTension  )
% Inverse Kinematics Solver with Pseudoinverse V1.1
%   By Ellande Tang, Mallory Daly, Drew Sabelhaus
% Last edited: Dec. 15, 2017

% This version of the inverse kinematics solver uses Jeff Friesen's
% formulation, which explicitly solves for the pseudoinverse of A in Aq=p, 
% and therefore reformulates the optimization problem. To-be-determined
% is if the solutions get better...
...
% TO-DO:
%   Also, need to check that we're not constraining rods to be
